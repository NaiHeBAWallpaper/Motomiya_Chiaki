...
const AUDIO_DETAIL = [
	{
		...
		dialog: {
			Japanese: [
				"あははっ！シャッターチャンス、とらえました！",
				"居眠りする先生の顔！次号の表紙にピッタリです！"
			],
			English: [
				"Ahaha, I've took the picture!",
				"Your dozing face would make the perfect main cover for next week's volume!"
			],
			Chinese: [
				"啊哈哈！机会抓住！",
				"睡着的老师的模样，正适合下周的周刊头版！"
	...
	},
	{
		...
		dialog: {
			Japanese: [
				"これで「週刊万魔殿」特集号の準備は万全！",
				"さっすが私！またスクープをゲットしちゃいました～！"
			],
			English: [
				"Now we're all set for the special edition of \"Weekly Pandemonium\"!",
				"Good job me, getting another amazing scoop!"
			],
			Chinese: [
				"这样一来万魔殿的周刊特集的准备就万无一失了！",
				"真不愧是我！又抓拍到独家新闻了～！"
			]
		}
	},
	{
		...
		dialog: {
			Japanese: [
				"ふふっ、書記の行動力、侮っちゃいけませんよ～？"
			],
			English: [
				"Fufu, the instincts of a secretary is not to be ignored, you know~?"
			],
			Chinese: [
				"哼哼，不能轻视书记的行动力哟～"
			]
	...
	},
	{
		...
		dialog: {
			Japanese: [
				"そうだ！この勢いで、先生の謎に迫っていきましょうか……？",
				"靴下に空いた穴の謎、とか……！"
			],
			English: [
				"I know! While we're on it what about we go on uncovering Sensei's mysteries too?",
				"Like the mysterious hole in their sock.. maybe!"
			],
			Chinese: [
				"有了！趁着这份势头，将老师的秘密全部逼迫出来吧？",
				"比如袜子上的洞的谜题什么的！"
			]
		}
	},
	{
		...
		dialog: {
			Japanese: [
				"えっ！意地悪な子は「机の下閉じ込めの刑」に処す……！？",
				"ご、ごめんなさ～い！出してください～！"
			],
			English: [
				"Eh!? Bad girls get trapped under the desk..!?",
				"I- I'm sorry~! Let me out~!"
			],
			Chinese: [
				"欸！要让捣乱的学生尝尝桌下禁闭的处罚...！？",
				"对，对不起！放我出去吧！"
...
const HITBOX = {
	headpat: { xMin: 400, xMax: 1050, yMin: 50, yMax: 500 },
	voiceline: { xMin: 770, xMax: 2050, yMin: 900, yMax: 1600 }
};
